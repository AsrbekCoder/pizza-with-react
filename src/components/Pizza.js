  ...
  return (
    <div className="pizza-block">
      ...
      <div className="pizza-block__selector">
        <ul>
          {avaibleTypes.map((item, idx) => (
            <li
              onClick={() => selectActiveTypes(idx)}
              key={idx}
              className={classNames({
                active: activeTypes === idx,
        ...
        <ul>
          {avaibleSizes.map((sizePizza, idx) => (
            <li
              onClick={() => selectActiveSizes(idx)}
              key={idx}
              className={classNames({
                active: activeSizes === idx,
                disabled: !sizes.includes(sizePizza),
              })}
            >
              {sizePizza} см.
            </li>
