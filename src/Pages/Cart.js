...
const Cart = () => {
  ...
  const clearCart = () => {
    if (window.confirm("VI XOtite ochistis korzinu?")) dispatch(setClear());
  };
        ...
        <div className="cart">
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              <span>
                {" "}
                Всего пицц: <b>{itemCounter ? itemCounter : "0"} шт.</b>{" "}
              </span>
              <span>
                {" "}
                Сумма заказа: <b>{itemPrice} ₽</b>{" "}
              </span>
            </div>
